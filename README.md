...
- 📎 **Attachments Support**: Press `a` to view a list of attachments on the current email (including inline images), download them locally to your `Downloads` directory, and automatically open them using `xdg-open`.
